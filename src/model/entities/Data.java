...
public class Data {
	...
	public String getData() {
		...
		if (dia > 31) {
			...
			System.out.println("Error: Mês maior que 12!");

		} else if (mes < 01) {

			System.out.println("Error: Mês menor que 1!");
			...
			if (dia <= 30) {
				...
				System.out.println("Error: Esse mês '" + mes + "' não pode ter mais que 30 dias!");
			...
			if (validarFevereiro == true) {
				...
				if (dia > 28) {
					...
					System.out.println("Error: Mês de fevereiro não bissexto, tem somente 28 dias");
